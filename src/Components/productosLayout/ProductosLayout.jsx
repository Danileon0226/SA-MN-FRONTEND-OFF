...
import { agregarConjunto, quitarCantidad } from "../../Store/Slices";
            ...
            <div className="ProductosForm">
                ...
                <div className="ProductosContainer">
                    {productos.map((producto, index) => {
                        const conjuntoEnEstado = productosEnState.find(
                            (conjunto) =>
                                conjunto.id_producto === producto.id_producto
                        );
                        const cantidadAcumulada = conjuntoEnEstado
                            ? conjuntoEnEstado.cantidad
                            : 0;
                        ...
                        return (
                            <div key={index} className="productoCard">
                                ...
                                <p className="EnInventario">
                                    <b>En inventario: </b> {producto.stock}
                                </p>
                                <p className="PrecioUnidad">
                                    ${producto.valor_producto}
                                </p>
                                {producto.stock === 0 ? (
                                    <p className="NoHay">NO HAY EN INVENTARIO</p>
                                ) : (
                ...
                <div className="LayoutControles">
                    <button
                        disabled={productosEnState.length === 0}
                        onClick={() => abrirMesero()}>
                        Seleccionar Mesero
                    </button>
                </div>
